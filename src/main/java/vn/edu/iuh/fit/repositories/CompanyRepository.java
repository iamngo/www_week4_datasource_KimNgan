...
public class CompanyRepository {
    ...
    public boolean create(Company company){
        ...
        return jdbcTemplate.update(sql, company.getId(), company.getName(), company.getAbout(), company.getAddress().getId(), company.getEmail(), company.getPhone(), company.getWebUrl()) > 0;
    }
